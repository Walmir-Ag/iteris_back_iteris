const criandoCartasController = async(req,res) =>{
    ...
    await db.sync()
    const {name, type, attributes, hp, attack, defense, special_attack, special_defense, speed} = req.body;
    const novaCarta = await carta.create({
        name, type, attributes, hp, attack, defense, special_attack, special_defense, speed
    });
